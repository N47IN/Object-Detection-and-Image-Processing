...
class MaskRCNN:
    def __init__(self):
        # Loading Mask RCNN
        self.net = cv2.dnn.readNetFromTensorflow("/home/navin/maskrcnn/dnn/frozen_inference_graph_coco.pb",
                                            "/home/navin/maskrcnn/dnn/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt")
        ...
        self.classes = []
        with open("/home/navin/maskrcnn/dnn/classes.txt", "r") as file_object:
...
k = MaskRCNN()
img = cv2.imread("/home/navin/colcon_ws/src/ur_description/scripts/room.jpeg")
k.detect_objects_mask(img)
img = k.draw_object_mask(img)
